...
The current docs philosophy, layout, Diátaxis model, CLI inspection surface, freshness model, and generated-output contract are documented in [`../documentation-model.md`](../documentation-model.md). This older spec page remains a compact implementation note.
