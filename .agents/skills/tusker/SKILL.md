---
name: tusker
description: "Track, plan, document, or close repo-local work in a markdown vault. Use for epics, tasks, bugs, docs, documentation tickets, evidence, validation, backlogs, specs, docs sites, resume/status, or close requests."
---
