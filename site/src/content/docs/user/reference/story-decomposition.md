...
description: "A design doc is not executable work."
tusker:
  audience: "user"
  publish_path: "user/reference/story-decomposition"
  publish_section_title: "Reference"
  route: "/user/reference/story-decomposition/"
  source_kind: "repo_doc"
  source_path: "skill/references/STORY_DECOMPOSITION.md"
  summary: "A design doc is not executable work."
  tags:
    - "reference"
  updated: "2026-04-22"
---
