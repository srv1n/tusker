...
description: "The skill payload ships .base files in assets/bases/. Live vault views live in _system/views/."
tusker:
  audience: "user"
  ...
  summary: "The skill payload ships .base files in assets/bases/. Live vault views live in _system/views/."
  tags:
    - "reference"
  updated: "2026-05-04"
---
