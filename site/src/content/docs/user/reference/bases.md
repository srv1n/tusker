---
title: "Bases — editing and extending"
description: "The shipped .base files live in assets/bases/ and are embedded into the compiled tusker binary. On tusker bootstrap, they are written to _system/views/ in the target vault."
tusker:
  audience: "user"
  publish_path: "user/reference/bases"
  publish_section_title: "Reference"
  route: "/user/reference/bases/"
  source_kind: "repo_doc"
  source_path: "skill/references/BASES.md"
  summary: "The shipped .base files live in assets/bases/ and are embedded into the compiled tusker binary. On tusker bootstrap, they are written to _system/views/ in the target vault."
  tags:
    - "reference"
  updated: "2026-04-22"
---
