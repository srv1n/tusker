...
description: "Tusker supports three legitimate canon patterns. Pick one per epic, make it explicit, then create the task stack that executes it."
tusker:
  audience: "user"
  ...
  summary: "Tusker supports three legitimate canon patterns. Pick one per epic, make it explicit, then create the task stack that executes it."
  tags:
    - "reference"
  updated: "2026-04-30"
---
