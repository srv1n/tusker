...
description: "Reference algorithm for a cron-driven binary that turns the vault's dashboard.json into agent runs. This is the contract the Tusker CLI exposes; the dispatcher does not hand-parse markdown."
tusker:
  audience: "developer"
  ...
  summary: "Reference algorithm for a cron-driven binary that turns the vault's dashboard.json into agent runs. This is the contract the Tusker CLI exposes; the dispatcher does not hand-parse markdown."
  tags:
    - "internals"
  updated: "2026-04-22"
---
