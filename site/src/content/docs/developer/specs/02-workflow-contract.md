---
title: "Spec 02: Workflow Contract"
...
- The durable tracker state machine comes from [01-vault-tracker.md](/developer/specs/01-vault-tracker/).
- The daemon runtime store comes from [03-daemon-and-registry.md](/developer/specs/03-daemon-and-registry/).
