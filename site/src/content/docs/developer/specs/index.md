...
description: "The implementation spec map for Tusker v2, including subsystem boundaries and build order."
tusker:
  audience: "developer"
  canonical: true
  ...
  summary: "The implementation spec map for Tusker v2, including subsystem boundaries and build order."
  tags:
    - "specs"
    - "architecture"
  updated: "2026-04-28"
