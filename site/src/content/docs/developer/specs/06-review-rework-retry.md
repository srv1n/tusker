---
title: "06. Review, Rework, Retry"
description: "Status: Draft Depends on: 01-vault-tracker.md, 03-daemon-and-registry.md, 05-runner-and-session-protocol.md"
tusker:
  audience: "developer"
  canonical: true
  ...
  summary: "Status: Draft Depends on: 01-vault-tracker.md, 03-daemon-and-registry.md, 05-runner-and-session-protocol.md"
  tags:
    - "specs"
  updated: "2026-04-28"
...
Status: Draft
Depends on: [01-vault-tracker.md](/developer/specs/01-vault-tracker/), [03-daemon-and-registry.md](/developer/specs/03-daemon-and-registry/), [05-runner-and-session-protocol.md](/developer/specs/05-runner-and-session-protocol/)
