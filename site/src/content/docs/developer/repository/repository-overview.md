...
- [`skill/SKILL.md`](/user/start-here/agent-workflow/) - operator skill
...
- [`skill/references/RISK_AND_EVIDENCE.md`](/user/reference/risk-and-evidence/) - proof policy
- [`skill/references/ENGINEERING_DISCIPLINE.md`](/user/reference/engineering-discipline/) - test and debugging discipline
- `tusker/docs/spec/tusker-v7-repo-local-work-tracker-spec.md` - V7 spec
