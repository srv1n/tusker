---
name: tusker
description: "Use for planning, logging, documentation, or tracking agent-first software work in an Obsidian vault. Create and manage epics, stories, bugs, specs, project docs, user guides, support/release docs, and docs-site content as markdown files; resume via list/status; capture follow-ups; and keep canon, execution, evidence, and review aligned. Triggers — log, track, backlog, what's next, epic, story, bug, doc, documentation, project docs, docs site, user guide, spec, RFC, resume, close, attest."
---
