...
func skillDoctorIssues(root string, packageMode, strict bool) ([]Issue, []Issue) {
	...
	if !packageMode {
		...
		if fileExists(filepath.Join(repoRoot, "go.mod")) || fileExists(filepath.Join(repoRoot, "skill")) {
			for _, rel := range []string{"skills/tusker/SKILL.md", "skills/tusker/README.md", "skills/tusker/references/TRACK.md", "skills/tusker/references/KNOWLEDGE.md", "skills/tusker/references/RUN.md", "skills/tusker/references/OPERATE.md"} {
