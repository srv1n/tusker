...
state_rev: "sha256:9e77ad69d7667fbb8dde06a9b8d6ecbc92588ba08cb13ccde965ed7bd86bd26c"
---
...
- Wave completion and execution authorization are separate. Completion remains derived from member closure; authorization is disarmed, armed, paused, or a derived stale projection. Read-only whole-wave preflight explains every blocker, and arm atomically binds authorization to the exact material spec/task/gate/dependency fingerprint while promoting only held members. Pause, stale authorization, and disarm stop future claims without forging outcomes for live workers.
