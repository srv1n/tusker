...
id: OBS-T-0002
title: Add docs media eval views
type: task
kind: feature
epic: OBS
status: ready
...
# OBS-T-0002 · Add docs media eval views

## Outcome

Obsidian surfaces stale docs, missing transcripts, unsupported promo claims, and docs eval status.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Docs freshness view lists stale/pending/verified doc_nodes. | view snapshot | snapshot | tusker/obsidian |
| 2 | Media view lists assets missing transcript or claim evidence. | view snapshot | snapshot | tusker/obsidian |
| 3 | Eval view lists evals by status/doc_node/kind. | view snapshot | snapshot | tusker/obsidian |

## Scope

### In

- Add generated/index-backed views.
- Link to docs-map and media-map.
- Update Dashboard.md.
...
|---|---|---|---|---|---|---|---|
| changed | obsidian | Docs/media/eval queues were not visible. | Obsidian becomes the review surface for freshness and media hygiene. | developer, agent | tusker/obsidian | reference, how-to | pending |
