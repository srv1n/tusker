...
id: OBS-T-0003
title: Ensure Obsidian renders source docs without Markdoc syntax
type: task
kind: feature
epic: OBS
status: ready
...
# OBS-T-0003 · Ensure Obsidian renders source docs without Markdoc syntax

## Outcome

Obsidian-readable source remains clean even when optional Markdoc publishing is enabled.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Task files never contain Markdoc tags. | source scan | scan output | tusker/obsidian |
| 2 | Agent runbooks and canonical docs avoid Markdoc tags or provide plain source equivalent. | validator/source scan | output | tusker/obsidian |
| 3 | Published-only enhancements do not break Obsidian source readability. | sample review | sample output | tusker/obsidian |

## Scope

### In

- Add scans/validator rule.
- Document restricted contexts.
- Add sample docs.
...
|---|---|---|---|---|---|---|---|
| changed | obsidian | Optional Markdoc could poison Markdown-first workflow. | Obsidian source remains clean and readable. | developer, agent | tusker/obsidian | reference, how-to | pending |
