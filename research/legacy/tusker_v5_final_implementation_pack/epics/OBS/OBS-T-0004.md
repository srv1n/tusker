...
id: OBS-T-0004
title: Add migration note and sample screens
type: task
kind: docs
epic: OBS
status: ready
...
# OBS-T-0004 · Add migration note and sample screens

## Outcome

Users understand how v5 migration changes their Obsidian vault and views.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Migration note explains story→task, bug→kind bug, D-note→docs page, docs-map/doc_nodes, and dashboards. | doc review | doc file | tusker/obsidian |
| 2 | Sample screens or markdown outputs show updated dashboards. | artifact review | screens/output | tusker/obsidian |
| 3 | Note links to migration command and rollback. | doc review | doc file | tusker/obsidian |
...
- Write guide.
- Attach screenshots or generated markdown snapshots.
- Link from README.
...
|---|---|---|---|---|---|---|---|
| changed | obsidian | Obsidian migration impact was implicit. | Users can see what changes in the vault. | developer, agent | tusker/obsidian | reference, how-to | pending |
