...
Tusker generates curated agent-readable docs indexes from docs-map.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | `llms.txt` is generated as curated index with concise descriptions. | snapshot test | llms.txt snapshot | tusker/docs-system |
| 2 | `llms-full.txt` is generated from selected plain Markdown docs in docs-map order. | snapshot test | llms-full snapshot | tusker/docs-system |
| 3 | Agent docs and reference docs are included prominently. | generated file review | generated output | tusker/docs-system |

## Scope

### In

- Use docs-map publish metadata and mode/audience.
- Include source paths and descriptions.
- Avoid private/internal docs unless configured.
...
|---|---|---|---|---|---|---|---|
| changed | docs-system | AI-readable docs indexes were manual or missing. | llms files are generated from docs catalog. | developer, agent | tusker/docs-system | reference, how-to | pending |
