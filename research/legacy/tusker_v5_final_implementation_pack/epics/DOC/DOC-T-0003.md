...
id: DOC-T-0003
title: Add first-class agent docs templates
type: task
kind: feature
epic: DOC
status: ready
...
# DOC-T-0003 · Add first-class agent docs templates

## Outcome

Tusker ships agent-facing templates for quickstarts, setup recipes, runbooks, contracts, permissions, manual intervention, rollback, and eval tasks.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Agent recipe template includes Goal, Inputs, Preconditions, Steps, Validation, Failure modes, Rollback, Escalate when. | template review | template file | tusker/docs-system |
| 2 | Agent docs are mapped as audience agent and agent_layer standalone. | docs-map validator | validator output | tusker/docs-system |
| 3 | Agent docs remain plain Markdown without Markdoc tags. | forbidden-context test | test output | tusker/docs-system |

## Scope

### In

- Create docs/agents templates.
- Add docs-map nodes.
- Update llms generation ordering.
...
|---|---|---|---|---|---|---|---|
| changed | docs-system | Agent use was implied through skills but not surfaced as durable docs. | Agent-facing docs are explicit procedures and contracts. | developer, agent | tusker/docs-system | reference, how-to | pending |
