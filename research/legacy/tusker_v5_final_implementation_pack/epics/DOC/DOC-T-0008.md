...
Humans can see stale doc_nodes, latest verification, pending docs impact, and waivers inside Obsidian.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | docs.index.json contains last verified event, stale_due_to, linked tasks, waivers, and path for each doc_node. | reindex fixture | docs.index.json | tusker/docs-system |
| 2 | Dashboard view lists stale and pending docs. | view snapshot | Dashboard excerpt | tusker/docs-system |
| 3 | Closing a task updates docs freshness state. | close fixture | before/after index | tusker/docs-system |

## Scope

### In

- Derive from docs-map, events, tasks, and knowledge deltas.
- Materialize verified_at in doc frontmatter if configured.
- Add views.
...
|---|---|---|---|---|---|---|---|
| changed | docs-system | Docs freshness had no operating surface. | Docs freshness becomes visible and queryable. | developer, agent | tusker/docs-system | reference, how-to | pending |
