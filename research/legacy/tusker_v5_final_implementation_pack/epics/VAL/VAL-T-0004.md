...
id: VAL-T-0004
title: Validate Diátaxis mode audience and agent_layer
type: task
kind: feature
epic: VAL
status: ready
...
# VAL-T-0004 · Validate Diátaxis mode audience and agent_layer

## Outcome

Docs-map and doc pages only use allowed mode, audience, and agent_layer values.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Invalid mode/audience/agent_layer fails validation. | fixture | test output | tusker/tasks |
| 2 | Agent standalone docs require inputs/preconditions/validation/failure modes/escalate rules. | fixture | test output | tusker/tasks |
| 3 | Public IA does not require raw mode labels. | catalog snapshot | snapshot | tusker/tasks |
...
- Implement agent-doc section checks.
- Add helpful errors.
...
|---|---|---|---|---|---|---|---|
| changed | validator | Docs mode could be freeform or missing. | Docs mode/audience/agent_layer are controlled. | developer, agent | tusker/tasks | reference, how-to | pending |
