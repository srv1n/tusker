...
id: CLI-T-0005
title: Update help output aliases and command docs
type: task
kind: docs
epic: CLI
status: ready
...
# CLI-T-0005 · Update help output aliases and command docs

## Outcome

Help output matches the v5 command surface and migration aliases are clearly marked.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | CLI help documents the 10 stable primitives. | help snapshot | snapshot | tusker/cli |
| 2 | Deprecated aliases show migration warnings. | CLI test | test output | tusker/cli |
| 3 | CLI reference doc is updated via docs-map node. | docs impact check | doc patch | tusker/cli |
...
- Update skill command reference.
...
|---|---|---|---|---|---|---|---|
| changed | cli | Help output reflected old story workflow. | Help output teaches v5 task/docs/evidence workflow. | developer, agent | tusker/cli | reference, how-to | pending |
