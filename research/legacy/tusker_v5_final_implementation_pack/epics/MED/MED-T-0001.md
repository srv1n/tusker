...
id: MED-T-0001
title: Introduce media-map and media asset schema
type: task
kind: feature
epic: MED
status: ready
...
# MED-T-0001 · Introduce media-map and media asset schema

## Outcome

Tusker has a controlled registry for demo videos, screenshots, diagrams, walkthroughs, and promo assets.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | media-map defines assets, source_task, doc_nodes, files, transcript, chapters, claims, publish surfaces. | schema parser test | test output | tusker/media |
| 2 | Media assets can be referenced from docs-map and task evidence. | fixture test | index output | tusker/media |
| 3 | Video assets require transcripts and chapters by default. | validator fixture | test output | tusker/media |
...
|---|---|---|---|---|---|---|---|
| changed | media | Media was an attachment/evidence blob. | Media is reusable traceable asset with transcript, doc_nodes, and claims. | developer, agent | tusker/media | reference, how-to | pending |
