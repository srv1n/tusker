...
id: MED-T-0003
title: Add evidence-to-doc-media promotion workflow
type: task
kind: feature
epic: MED
status: ready
...
# MED-T-0003 · Add evidence-to-doc-media promotion workflow

## Outcome

Task evidence can be promoted into reusable docs/tutorial/demo assets without becoming source of truth.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Workflow identifies eligible evidence artifacts and proposes media-map entries. | fixture dry-run | proposal output | tusker/media |
| 2 | Promoted media links back to source task and doc_nodes. | media index test | media-map output | tusker/media |
| 3 | Promotion requires transcript/companion before publication. | validator fixture | test output | tusker/media |

## Scope

### In

- Add optional media promote workflow.
- Generate companion stub from evidence metadata.
- Record event.
...
|---|---|---|---|---|---|---|---|
| changed | media | Evidence and docs/promo media were disconnected. | Evidence can become traceable reusable media. | developer, agent | tusker/media | reference, how-to | pending |
