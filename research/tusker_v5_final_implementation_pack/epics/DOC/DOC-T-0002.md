...
id: DOC-T-0002
title: Add Diátaxis-aware doc template
type: task
kind: feature
epic: DOC
status: ready
...
# DOC-T-0002 · Add Diátaxis-aware doc template

## Outcome

Durable doc pages have a template that enforces one dominant reader intent and optional agent capsule support.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Doc template supports tutorial/how-to/reference/explanation modes. | template review | template file | tusker/docs-system |
| 2 | Doc template includes source_of_truth and stale_when. | validator fixture | test output | tusker/docs-system |
| 3 | Agent capsule appears only for capsule/standalone agent_layer. | template/validator fixture | test output | tusker/docs-system |
...
- Add template.
- Update docs creation flow.
- Add one reference example and one agent how-to example.
...
|---|---|---|---|---|---|---|---|
| changed | docs-system | Doc templates were thin or tracker-oriented. | Doc templates encode dominant reader intent and freshness metadata. | developer, agent | tusker/docs-system | reference, how-to | pending |
