...
id: MRK-T-0005
title: Export clean plain Markdown from published docs
type: task
kind: feature
epic: MRK
status: ready
...
# MRK-T-0005 · Export clean plain Markdown from published docs

## Outcome

Published docs with components have clean Markdown exports for agents and llms generation.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Every supported component renders to useful plain Markdown. | export snapshot tests | snapshots | tusker/markdoc |
| 2 | llms-full uses Markdown export, not HTML or opaque component markup. | llms generation test | llms-full output | tusker/markdoc |
| 3 | Media components export transcript/summary links. | media export fixture | export output | tusker/markdoc |

## Scope

### In

- Implement exporter for allowed tags.
...
|---|---|---|---|---|---|---|---|
| changed | publishing | Components risked making docs less extractable. | Components render to clean text for agents. | developer, agent | tusker/markdoc | reference, how-to | pending |
