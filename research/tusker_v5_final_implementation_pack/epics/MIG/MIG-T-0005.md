...
id: MIG-T-0005
title: Clean legacy frontmatter fields during migration
type: task
kind: migration
epic: MIG
status: ready
...
# MIG-T-0005 · Clean legacy frontmatter fields during migration

## Outcome

Migration removes legacy generated/runtime/audit fields and preserves meaningful history elsewhere.

## Acceptance contract

| AC | What must be true | Verification | Deliverables | Doc nodes |
|---:|---|---|---|---|
| 1 | Legacy fields are removed from task/doc frontmatter. | fixture validation | cleaned file diff | tusker/migration |
| 2 | Human-useful fields are preserved or renamed. | migration report review | field mapping report | tusker/migration |
| 3 | Valuable runtime/audit data moves to events/runs or is reported. | event fixture | event output | tusker/migration |
...
- Generate warning for unknown non-empty fields.
- Add fixture with all legacy fields.
...
|---|---|---|---|---|---|---|---|
| changed | work-model | Legacy frontmatter carried many empty/generated fields. | Migration trims frontmatter and preserves meaningful history elsewhere. | developer, agent | tusker/migration | reference, how-to | pending |
