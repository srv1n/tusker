...
var FrontmatterOrder = map[string][]string{
	"task": {
		...
		"contract_fingerprint", "dependency_contracts", "close_policy_snapshot", "proof_contract", "proof_results", "strict_proof_lineage", "requirement_refs", "artifact_contract", "work_kind", "owned_paths", "generated_outputs", "migration_keys", "resource_refs", "runner_profile", "work_level", "review_level", "complexity", "concurrency_group", "knowledge_nodes", "batch_gate_command", "batch_gate_run",
	...
	"gate": {
		...
		"covers", "dependency_closure", "dependency_material_fingerprint", "why_agent_cannot", "action", "suggestion", "verification", "satisfaction_evidence", "satisfaction_evidence_refs", "satisfied_by", "satisfied_at", "waived_by", "waived_at", "waive_reason", "obsolete_reason",
		"created_at", "created_by", "updated_at", "updated_by", "state_rev",
	},
	"epic": {
	...
	"wave": {
		...
		"authoring_receipt", "strict_proof_lineage", "concurrency", "runner_profile", "landings", "landed_at",
