...
var FrontmatterOrder = map[string][]string{
	...
	"wave": {
		"schema", "kind", "id", "project", "title", "summary", "status", "members", "integration_branch", "integration_base_sha", "spec_refs", "requirements", "shared_resources", "owned_path_overlaps", "assumptions", "unresolved_decisions", "delivery_plan_scope", "delivery_plan_fingerprint", "concurrency", "runner_profile", "landings", "landed_at",
