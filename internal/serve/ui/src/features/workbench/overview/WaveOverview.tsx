                  ...
                  <li key={entry.wave.id} className="wux-ov-row">
                    ...
                    >
                      ...
                      <div className="wux-ov-side">
                        {entry.group !== "completed" && (entry.wave.authorization.state === "armed" || entry.wave.authorization.state === "disarmed") ? <span className="wux-ov-state wux-ov-tone-neutral">{entry.wave.authorization.state === "armed" ? "Armed" : "Not armed"}</span> : null}
